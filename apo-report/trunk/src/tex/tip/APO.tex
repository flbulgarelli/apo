\section{Nuestra herramienta: }
	...
	propuesta en la Sección \ref{Solucion}, y cumpliendo el objetivo detallado
	en la Sección \ref{Objetivo}. Se desarrollaron dos herramientas
	...
	\subsection{Desarrollo de Aspect for Pure Objects}
		...
		pero a su vez el código que requiere es poco entendible.
		...
		advice) y un objeto del tipo  \code{WeavingInstrumentor} (que
