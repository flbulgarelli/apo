...
\subsection{Desarrollo de Aspect for Pure Objects}
	...
	de \code{PointCuts}, por ejemplo, \code{SuperclassPointCut}, \code{FieldPointCut}, 
	...
	sobre las clases seleccionadas. Para ello, tiene una coleccion de \code{Interceptors}.
 	Los  \code{Interceptors} son objetos que le intereza interceptar un concepto especifíco,  por ejemplo
 	...
 	Existen varias estrategias de modificación siguiendo la teoria de AOP, \code{Before}, \code{After}, \code{Arround},
 	\code{ReadField} y \code{WriteField}. 
